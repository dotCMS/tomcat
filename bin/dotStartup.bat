...
set JAVA_OPTS=-Djava.awt.headless=true -Xverify:none -Dfile.encoding=UTF8 -server -Xmx1G -Djava.endorsed.dirs=%DOTCMS_HOME%/WEB-INF/endorsed_libs -XX:+DisableExplicitGC -XX:+UseConcMarkSweepGC -javaagent:%CATALINA_HOME%/lib/dot.jamm_0.3.1.jar
